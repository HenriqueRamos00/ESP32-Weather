        ...
        <div class="p-4">
          <div class="flex flex-col gap-4 md:flex-row md:items-end">
            ...
            <div class="flex gap-2">
              <button
                class="bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 text-white px-4 py-2 rounded transition-colors"
              ...
              <button
                class="bg-slate-900 hover:bg-slate-700 border border-slate-700 disabled:opacity-50 text-white px-4 py-2 rounded transition-colors"
                :disabled="disabled"
                @click="emit('reset')"
              >
                Reset
